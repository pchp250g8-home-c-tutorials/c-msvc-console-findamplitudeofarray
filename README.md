FindAmplitudeOfArray. C Tutorials. Microsoft Visual Studio IDE. Simple Input/Output. Arrays. Algorithms. Console application. 
...
Программа делает следующее:
  ...
  4. Вводятся переменные для индекса максимального и минимального элемента массива и их значений.
     Индексы элементов равны 0, а значения - значению первого (нулевого)     элемента массива.
  5. Выполняется второй цикл с параметром.
     5.1. Начальное значение параметра устанавливается равным 1, а конечное - числу элементов массива - 1.
          Поиск элеметов будет начинаться с элемента № 2 (1, нумерация массива идёт с 0).
